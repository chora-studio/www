    ...
    <div className={styles.container}>
      <div className={styles.sectionText}>
        <div>
          ...
          <p>
            {'Chora Validator is committed to ensuring the security and integrity of every network that Chora Validator operates on. Chora Validator is operated by a team of senior software engineers with more than two years of experience building, maintaining, and testing software within Cosmos ecosystem.'}
          </p>
          <h3>{'Regen'}</h3>
          <p>
            {
